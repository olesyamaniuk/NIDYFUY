document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-e-navigation-list");
  const headerRef = document.querySelector(".q-e-header");
  const navigationRef = document.querySelector(".q-e-navigation");
